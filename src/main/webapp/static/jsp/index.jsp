...
<title>银行数据分析网络-V2版</title>
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/css/bootstrap.css">
<link href="${pageContext.request.contextPath}/css/component.css" rel="stylesheet">
    ...
    .attr('fill','#FF9800');//箭头颜色
        ...
        nodeEnter.append("svg:image")
            ...
            .attr("xlink:href", function (d) {
                return (d.img == null || d.img == "") ? "${pageContext.request.contextPath}/images/person.png" : "${pageContext.request.contextPath}/images/" + d.img;
            })
            .attr("x", "-32px")
            .attr("y", "-32px")
            .attr("width", "64px")
